...
export type Callback<TOutput = unknown > = (event: EventData<TOutput>,...args:Array<any>)=>Promise<TOutput>|Promise<EventStatus>|Promise<undefined>|TOutput|EventStatus|undefined|void|Promise<void>;
...
export type Filter = ($data:ArbitraryObject, $strings: Array<string>, $captures: Array<string>)=> boolean;
