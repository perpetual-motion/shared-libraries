...
export class LineIterator implements AsyncIterable<string>, AsyncIterator<string> {
  ...
  [Symbol.asyncIterator](): AsyncIterator<string, string, undefined> {
    return this;
  }
 ...
 */
export class ReadableLineStream {
...
export class ReadWriteLineStream extends ReadableLineStream {
  ...
  async write(...text: Array<string>): Promise<void> {
    let content = text;
  ...
  async writeln(...text: Array<string>): Promise<void> {
    let content = text;
...
class WriteableLineStream {
  ...
  write(...text: Array<string>): Promise<void> {
