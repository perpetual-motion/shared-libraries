...
export class Scanner implements Token {
  ...
  *takeUntil(endToken: Kind, options?: { escape?: Array<Kind>, nestable?: Array<[Kind,Kind]>}, yieldFinalClose?: boolean): Iterable<Token> {
    ...
    processing: do {
      ...
      for (const [open,close] of nestable as Array<[Kind,Kind]>) {
        if (this.kind === open) {
